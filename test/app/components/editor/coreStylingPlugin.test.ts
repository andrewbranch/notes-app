...
// import { boldWithSelectionAtEnd, boldWithSelectionAtStart, boldHelloSelectedFrom4ToEnd, boldHelloSelectedFrom7ToEnd, helloBoldSelectedFromStartTo10, helloBoldSelectedFromStartTo7, italicWithSelectionAtEnd, boldWithSelectionAtStartAndLeadingSpace } from './fixtures';
...
//   //         const provider = await createEditorProvider({ initialEditorState: boldWithSelectionAtStartAndLeadingSpace });
//   //         await provider.setSelection({ focusOffset: 2 });
//   //         expect(provider.getEditorState().getSelection().getAnchorOffset()).toBe(1);
//   //         expect(provider.getEditorState().getSelection().getFocusOffset()).toBe(2);
//   //         await provider.typeText('a');
//   //         expect(provider.getEditorState()).toMatchSnapshot();
//   //       });
//   //     });
